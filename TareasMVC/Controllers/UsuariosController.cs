...
namespace TareasMVC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(UserManager<IdentityUser> userManager, // Inyección de dependencias para UserManager
            SignInManager<IdentityUser> signInManager, // Inyección de dependencias para SignInManager
            ApplicationDbContext context) // Constructor para inyectar dependencias
        {
            ...
            string remoteError = null)
        {
            ...
            // Se debe crear la cuenta porque no existe.
            string email = "";
        ...
        {
            var usuario = await context.Users.Where(u => u.Email == email).FirstOrDefaultAsync(); // Buscar el usuario por email
            ...
            await userManager.AddToRoleAsync(usuario, Constantes.RolAdmin); // Asignar el rol de administrador al usuario
