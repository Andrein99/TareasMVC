...
async function obtenerTareas() {
    ...
    const json = await respuesta.json();
    tareaListadoViewModel.tareas([]); // Limpiar la lista antes de agregar nuevas tareas
...
async function manejarClickTarea(tarea) {
    ...
    tareaEditarVM.pasos([]); // Se limpia el arreglo de pasos antes de añadir los datos cada vez.
